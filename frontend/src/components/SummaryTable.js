...
function SummaryTable({
    ...
    const printReceipt = async (paymentId) => {
        try {
            // Using the shared api service (handles base URL, /api prefix, and session tokens)
                ...
                <head>
                    ...
                    <style>
                        * { box-sizing: border-box; }
                        ...
                        .receipt-number { font-weight: 700; }
                        .receipt-table {
                            width: 100%;
                        ...
                        .payment-section { margin-top: 7px; }
                        .payment-section h4 { margin: 0 0 4px; font-size: 12px; }
                        .payment-details {
                            display: grid;
                    ...
                    <div class="page">
                        ...
                        <div class="receipt">
                            ...
                            <div class="receipt-top">
                                <div>Receipt No: <span class="receipt-number">${receiptNumber}</span></div>
                                <div>Date: <strong>${paymentDate}</strong></div>
                            </div>
                            <table class="receipt-table">
                                <tr><td class="label">Academic Year</td><td>${academicYear}</td></tr>
                                <tr><td class="label">Student Name</td><td>${studentName}</td></tr>
                                <tr><td class="label">Roll Number</td><td>${rollNumber}</td></tr>
                                <tr><td class="label">Class</td><td>${className}</td></tr>
                                <tr><td class="label">Father / Parent</td><td>${fatherName}</td></tr>
                                <tr class="amount-row">
                            ...
                            <div class="payment-section">
                                ...
                                <div class="payment-details">
                                    ...
                                    <div class="payment-box"><strong>Payment Status</strong>Completed</div>
                                </div>
                            </div>
                            <div class="remarks"><strong>Remarks:</strong> ${remarks}</div>
                            <div class="signatures">
                                <div class="signature-box"><div class="signature-line">Parent / Guardian Signature</div></div>
                                <div class="signature-box"><div class="signature-line">Authorized Signature</div></div>
                            </div>
                            <div class="receipt-footer">Please retain this copy for your records. This is a computer-generated fee receipt.</div>
                        </div>

                        <!-- CUT LINE -->
                        <div class="cut-line"><span class="cut-symbol">✂</span> CUT HERE</div>
                        ...
                        <div class="receipt">
                            ...
                            <div class="copy-title">SCHOOL COPY</div>
                            <div class="receipt-top">
                                <div>Receipt No: <span class="receipt-number">${receiptNumber}</span></div>
                                <div>Date: <strong>${paymentDate}</strong></div>
                            </div>
                            ...
                            <div class="remarks"><strong>Remarks:</strong> ${remarks}</div>
                            <div class="signatures">
                                <div class="signature-box"><div class="signature-line">Cashier / Receptionist</div></div>
                                <div class="signature-box"><div class="signature-line">Authorized Signature</div></div>
                            </div>
                            <div class="receipt-footer">School copy — retain for school records. This is a computer-generated fee receipt.</div>
                        </div>
                    </div>
                </body>
                </html>
                    ...
                    {payments.length === 0 ? (
                        ...
                        payments.map((payment, index) => (
                            ...
                            >
                                ...
                                <td>
                                    <span
                                        className={`payment-badge ${getModeClass(
                                            payment.paymentMode
                                        )}`}
                                    >
                                        {payment.paymentMode}
